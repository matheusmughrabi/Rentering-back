...
{
    public class GuarantorMapping : IEntityTypeConfiguration<GuarantorEntity>
    {
        public void Configure(EntityTypeBuilder<GuarantorEntity> builder)
        {
            ...
            builder.Property(c => c.GuarantorStatus)
                .IsRequired()
                .HasColumnType("int");
